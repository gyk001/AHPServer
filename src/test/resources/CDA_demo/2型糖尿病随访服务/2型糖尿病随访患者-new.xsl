		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tr>
				...
				<td codeSystem="{}" width="40%">
					...
					<xsl:value-of select="n1:component[4]/n1:section/n1:entry[5]/n1:observation/n1:value/@unit">
					</xsl:value-of>
				</td>
				<td width="25%" align="right">
					<b>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[5]/n1:section/n1:entry/n1:asLaboratoryTest/..">				
					<tr>
						<td>
							<xsl:value-of select="n1:asLaboratoryTest/n1:asLaboratoryTestBloodSugar/n1:observation/n1:value/@value">
							</xsl:value-of>
							<xsl:value-of select="n1:asLaboratoryTest/n1:asLaboratoryTestBloodSugar/n1:observation/n1:value/@unit">
							</xsl:value-of>
						</td>
						<td>
							<xsl:value-of select="n1:asLaboratoryTest/n1:asLaboratoryTestBloodHemoglobin/n1:observation/n1:value/@value">
							</xsl:value-of>
							<xsl:value-of select="n1:asLaboratoryTest/n1:asLaboratoryTestBloodHemoglobin/n1:observation/n1:value/@unit">
							</xsl:value-of>
						</td>
						<td>
