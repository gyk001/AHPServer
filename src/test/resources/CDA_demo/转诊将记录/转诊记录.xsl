...
<!--个人建档信息-->
	...
	<xsl:template match="/n1:ClinicalDocument/n1:component/n1:structuredBody">
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="left">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[1]/n1:section/n1:entry/n1:asDiagnose/..">				
					<tr>
						<td codeSystem="{$ICD10R}">
							<xsl:value-of select="n1:asDiagnose/n1:asDiagnoseInfor/n1:observation/n1:value/@code">
							</xsl:value-of>
						</td>
					</tr>
				</xsl:for-each>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[2]/n1:section/n1:entry/n1:asLaboratoryTest/..">				
					<tr>
						<td>
							<xsl:value-of select="n1:asLaboratoryTest/n1:asSupplementalTest/n1:observation/n1:value">
							</xsl:value-of>
						</td>
						<td>
							<xsl:value-of select="n1:asLaboratoryTest/n1:asSupplementalResult/n1:observation/n1:value">
							</xsl:value-of>								
						</td>
					</tr>
				</xsl:for-each>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tr>
				<td width="10%">
					<b>
						<xsl:text>现病史描述: </xsl:text>
					</b>
				</td>
				<td width="40%">
					<xsl:value-of select="n1:component[3]/n1:section/n1:entry/n1:observation/n1:text">
					</xsl:value-of>
				</td>
			</tr>
		</table>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[4]/n1:section/n1:entry/n1:act/..">				
					<tr>
						<td codeSystem="{$CV02.10.006}">
							<xsl:value-of select="n1:act/n1:code/@code">
							</xsl:value-of>
						</td>
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[5]/n1:section/n1:entry/n1:observation/..">				
					<tr>
						...
						<td>
							<xsl:value-of select="n1:observation/n1:entryRelationship/n1:act/n1:performer/n1:assignedEntity/n1:representedOrganization/n1:asOrganizationPartOf/n1:wholeOrganization/n1:name/@literal">
							</xsl:value-of>
						</td>
					</tr>
				</xsl:for-each>
