	...
	<xsl:template match="/n1:ClinicalDocument/n1:component/n1:structuredBody">	
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tr>
				<td width="10%">
					<b>
						<xsl:text>重性精神疾病患者危险性: </xsl:text>
					</b>
				</td>
				<td codeSystem="{$CV05.10.013}" width="40%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[1]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
				<td width="25%" align="right">
					<b>
				...
				<td codeSystem="{$CV04.01.009}" width="25%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[2]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
			</tr>
			<tr>
				<td width="10%">
					<b>
						<xsl:text>自知力评价结果: </xsl:text>
					</b>
				</td>
				<td codeSystem="{}" width="40%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[3]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
				<td width="25%" align="right">
					<b>
						<xsl:text>睡眠状况：</xsl:text>
					</b>
				</td>
				<td codeSystem="{}" width="25%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[4]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
			</tr>
			<tr>
				<td width="10%">
					<b>
						<xsl:text>饮食情况: </xsl:text>
					</b>
				</td>
				<td codeSystem="{}" width="40%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[5]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
				<td width="25%" align="right">
					<b>
						<xsl:text>社会功能情况：</xsl:text>
					</b>
				</td>
				<td codeSystem="{$CV05.10.003}" width="25%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[6]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
			</tr>
			<tr>
				<td width="10%">
					<b>
						<xsl:text>社会功能情况评价: </xsl:text>
					</b>
				</td>
				<td codeSystem="{}" width="40%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[7]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
				<td width="25%" align="right">
					<b>
						<xsl:text>患重性精神疾病对家庭社会的影响：</xsl:text>
					</b>
				</td>
				<td codeSystem="{$CV03.00.112}" width="25%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[8]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
			</tr>
			<tr>
				...
				<td width="25%">
					<xsl:value-of select="n1:component[2]/n1:section/n1:entry[10]/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
			</tr>
		</table>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[3]/n1:section/n1:entry/n1:asHospitalizationHistory/..">				
					<tr>
						<td>
							<xsl:call-template name="formatDate">
								<xsl:with-param name="date" select="n1:asHospitalizationHistory/n1:asHospitalizationCondition/n1:observation/n1:effectiveTime/@value">
								</xsl:with-param>
							</xsl:call-template>								
						</td>
						<td codeSystem="{}">
							<xsl:value-of select="n1:asHospitalizationHistory/n1:asHospitalizationCondition/n1:observation/n1:value/@code">
							</xsl:value-of>
						</td>
					</tr>
				</xsl:for-each>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[4]/n1:section/n1:entry/n1:asLaboratoryTest/..">				
					<tr>
						<td>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[5]/n1:section/n1:entry/n1:substanceAdministration/..">				
					<tr>
						<td>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tr>
				...
				<td codeSystem="{$CV05.10.012}" width="40%">
					<xsl:value-of select="n1:component[6]/n1:section/n1:entry/n1:observation/n1:value/@code">
					</xsl:value-of>
				</td>
			</tr>
		...
		<table border="{$border}" class="{$className}" style="{$tableWidth}">
			...
			<tbody align="center">
				<xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component[7]/n1:section/n1:entry/n1:asHealthGuidance/..">				
					<tr>
						<td codeSystem="{$CV06.00.209}">
							<xsl:value-of select="n1:asHealthGuidance/n1:asHealthMehod/n1:observation/n1:value[1]/@code">
							</xsl:value-of>
						</td>
						<td>
							<xsl:value-of select="n1:asHealthGuidance/n1:asHealthMehod/n1:observation/n1:value[2]">
							</xsl:value-of>
						</td>
					</tr>
				</xsl:for-each>
